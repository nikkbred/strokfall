...
def main():
        ...
        with kol1:
            ...
            st.markdown(
                ...
                * S-pol diagram\n
                ...
                Dersom du velger å skrive inn målingene manuellt blir en tabell med dine data blir også laget, denne kan lastes ned som en Excel-fil. (.xlsx)
    ...
    with st.container():
        ...
        uploaded_file = st.file_uploader('Velg en fil (xls/xlsx):')
        if uploaded_file is not None:
            global df
            df = pd.read_excel(uploaded_file)
            with st.form(key='kalk'):
                st.form_submit_button(label='Kalkuler', on_click=trigger_2)

        st.markdown(f'''
            Eller skriv inn dine målinger manuelt:\n
...
def trigger():
    ...
    with st.container():
        ...
        with koll2:
            ...
            axpol.set_title('Tetthet av polene', y=1.08, fontsize=12)
            # axpol.grid()
    ...
    with st.container():
        ...
        with kolll1:
            ...
            axbet.set_title('Beta diagram', y=1.08, fontsize=12)
            axbet.grid()
        ...
        with kolll2:
            ...
            axs.set_title('S-pol diagram', y=1.08, fontsize=12)
            axs.grid()
...
def trigger_2():
    ...
    strok = df['Strøk' or 'Strok' or 'strok' or 'strøk' or 'Strike' or 'strike' or 'Strikes' or 'strikes'].tolist()
    fall = df['Fall' or 'fall' or 'Dip' or 'dip' or 'Dips' or 'dips'].tolist()
